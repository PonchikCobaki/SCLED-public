...
# SCLED Control
Прошивка устройства SCLED для модулей семейства Esp8266, фрэймворк - platformIO
...
Файл конфигурации сетей и основных настроек - settings.hpp
Палитры градиентов с возможностью редактрования и добавления - pallets.cpp
